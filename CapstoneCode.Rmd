...
cosalesrev <- read.csv("COMJSalesMonthReports2019.csv")
cotaxrev <- read.csv("COMJTaxMonthReports2019.csv")
...
cosalessummary <- read.csv("COMJSalesSummary2019.csv")
cotaxsummary <- read.csv("COMJTaxSummary2019.csv")
...
autoplot(train.ts) +
  ...
  ggtitle("2018-2022 Texas Pop by Mean, Naive, & Drift Forecasting") +
...
autoplot(train.ts) +
  ...
  ggtitle("2018-2022 Texas Pop by HW Forecasting") + xlab("Year") +
  ylab("Texas Pop") +
  guides(colour=guide_legend(title="Forecast"))
...
autoplot(texaspop14.pred) +
  ...
  xlab("Time") + ylab("Texas Pop") +
  ggtitle("2018-2022 Texas Pop by Combined Forecasting")
